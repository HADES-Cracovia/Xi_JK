...
void anaBkgd1(){
    ...
    THStack *hLmass_sc_rec = new THStack(); //Lambda scaled with cr_sec, no cuts
    ...
    */
    ...
    int a, b;
    double cntSL, cntSLsc, cntBL, cntBLsc, cntSX, cntSXsc, cntBX, cntBXsc, cntSLMtd, cntSLscMtd, cntSLLmass, cntSLscLmass, cntBLscLmass, cntSXMtd, cntSXscMtd, cntBLMtd, cnBLscMtd, cntBXMtd, cntBXscMtd, cntSLVert, cntSLscVert, cntSXVert, cntSXscVert, cntBLVert, cnBLscVert, cntBXVert, cntBXscVert;
	...
	//no cuts
	TH1F *hLall = (TH1F*)f1->Get("hMLPiHades");
	TH1F *hrealL = (TH1F*)f1->Get("hKLMass");
	TH1F *hXall = (TH1F*)f1->Get("hKmassall");
	TH1F *hXrealLpim = (TH1F*)f1->Get("hKmassRLpion");
	TH1F *hrealX = (TH1F*)f1->Get("hKmassRX");
	...
	//spectrum MTD_L
	TH1F *hMTD_Lall = (TH1F*)f1 -> Get("hPDpionproton");
	TH1F *hMTD_Lreal = (TH1F*)f1 -> Get("hPDlambda");

	//spectrum MTD_X
	TH1F *hMTD_Xall = (TH1F*)f1 -> Get("hKdistanceall");
	TH1F *hMTD_Xreal = (TH1F*)f1 -> Get("hKdistanceRealXi");
	...
	//MTD_L, Lmass, MTD_X
	TH1F *hLallMtd = (TH1F*)f1->Get("hMLDistSel");
	TH1F *hrealLMtd = (TH1F*)f1->Get("hKLMassDist");
	TH1F *hXallMtd = (TH1F*)f1->Get("hKmassdist");
	TH1F *hrealXMtd = (TH1F*)f1->Get("hKmassRXDist");
	...
	//spectrum Vertz_L
	TH1F *hVertz_Lall = (TH1F*)f1 -> Get("hVertexXZLproj");
	TH1F *hVertz_Lreal = (TH1F*)f1 -> Get("hVertexXZLreal");

	//spectrum Vertz_X
	TH1F *hVertz_Xall = (TH1F*)f1 -> Get("hVertexXZXproj");
	TH1F *hVertz_Xreal = (TH1F*)f1 -> Get("hVertexXZXreal");

	//MTD_L, Lmass, MTD_X, Vertz_X
	TH1F *hLallVert = (TH1F*)f1->Get("hMLDistVert");
	TH1F *hrealLVert = (TH1F*)f1->Get("hKLMassDistVert");
	TH1F *hXallVert = (TH1F*)f1->Get("hKmassdistVert");
	TH1F *hrealXVert = (TH1F*)f1->Get("hKmassRXDistVert");
	...
	*/
	...
	TH1F *clXiSc = (TH1F*)hXall -> Clone("hXall_chan");
	...
	*/
	...
	TH1F *clXiSc_fin = (TH1F*)hXallMtd -> Clone("hXall1sc_cMtd_fin");
	...
	*/
	...
	cVertZ_X -> cd(i+1);
	nice_canv1(gPad);
	hVertz_Xall1 -> GetXaxis() -> SetTitle("z [mm]");
	hVertz_Xall1 -> GetYaxis() -> SetRangeUser(0, 1100000);
	hVertz_Xall1 -> Draw();
	...
	*/
	...
	if(i == 0){
	  //no cuts
	  TH1F *hLall90 = hLall1 -> Clone("hLall90");
	  TH1F *hrealL90 = hrealL1 -> Clone("hrealL90");
	  TH1F *hXall90 = hXall1 -> Clone("hXall90");
	  TH1F *hXrealLpim90 = hXrealLpim1 -> Clone("hXrealLpim90");
	  TH1F *hrealX90 = hrealX1 -> Clone("hrealX90");
	
	  TH1F *hLall90Sc = hLall1sc -> Clone("hLall90Sc");
	  TH1F *hrealL90Sc = hrealL1sc -> Clone("hrealL90Sc");
	  TH1F *hXall90Sc = hXall1sc -> Clone("hXall90Sc");
	  TH1F *hXrealLpim90Sc = hXrealLpim1sc -> Clone("hXrealLpim90Sc");
	  TH1F *hrealX90Sc = hrealX1sc -> Clone("hrealX90Sc");
	  ...
	  //MTD_L, Lmass, MTD_X
	  TH1F *hLall90Mtd = hLall1Mtd -> Clone("hLall90Mtd");
	  TH1F *hrealL90Mtd = hrealL1Mtd -> Clone("hrealL90Mtd");
	  TH1F *hXall90Mtd = hXall1Mtd -> Clone("hXall90Mtd");
	  TH1F *hrealX90Mtd = hrealX1Mtd -> Clone("hrealX90Mtd");
	
	  TH1F *hLall90ScMtd = hLall1scMtd -> Clone("hLall90ScMtd");
	  TH1F *hrealL90ScMtd = hrealL1scMtd -> Clone("hrealL90ScMtd");
	  TH1F *hXall90ScMtd = hXall1scMtd -> Clone("hXall90ScMtd");
	  TH1F *hrealX90ScMtd = hrealX1scMtd -> Clone("hrealX90ScMtd");
	...
	//MTD_L, Lmass, MTD_X, Vertz_X
	  TH1F *hLall90Vert = hLall1Vert -> Clone("hLall90Vert");
	  TH1F *hrealL90Vert = hrealL1Vert -> Clone("hrealL90Vert");
	  TH1F *hXall90Vert = hXall1Vert -> Clone("hXall90Vert");
	  TH1F *hrealX90Vert = hrealX1Vert -> Clone("hrealX90Vert");
	
	  TH1F *hLall90ScVert = hLall1scVert -> Clone("hLall90ScVert");
	  TH1F *hrealL90ScVert = hrealL1scVert -> Clone("hrealL90ScVert");
	  TH1F *hXall90ScVert = hXall1scVert -> Clone("hXall90ScVert");
	  TH1F *hrealX90ScVert = hrealX1scVert -> Clone("hrealX90ScVert");
	  ...
	  hLall90ScVert -> SetLineWidth(3);
          hrealL90ScVert -> SetLineWidth(3);
          hXall90ScVert -> SetLineWidth(3);
	  hrealX90ScVert -> SetLineWidth(3);
    ...
    TH1F *hrealLSumPeakCl = hrealLSumPeak -> Clone();
    TH1F *hrealLSumPeakScCl = hrealLSumPeakSc -> Clone();
    ...
    TH1F *hrealXSumPeakCl = hrealXSumPeak -> Clone();
    TH1F *hrealXSumPeakScCl = hrealXSumPeakSc -> Clone();
    ...
    */
    ...
    hXallSum -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    ...
    */
    ...
    nice_canv1(gPad);
    hXallSumSc -> SetTitle("2#pi^{-} in Hades - anything (p) in FwDet");
    hXallSumSc -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    hXallSumSc -> GetYaxis() -> SetTitle("counts*#sigma");
    hXallSumSc -> Draw("pE1");
    hXall90Sc -> Draw("p same");
    l1 -> Draw("same");
    ...
    hXallSumSc -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    hXallSumSc -> GetYaxis() -> SetTitle("counts*#sigma");
    hXallSumSc -> SetMarkerStyle(20);
    hXallSumSc -> SetMarkerSize(.5);
    hXallSumSc -> SetMarkerColor(4);
    hXall90Sc -> SetMarkerStyle(20);
    hXall90Sc -> SetMarkerSize(.5);
    hXallSumSc -> Draw("pE1");
    hXall90Sc -> Draw("p same");
    l1 -> Draw("same");
    ...
    */
    ...
    nice_canv1(gPad);
    hXallSumSc -> SetTitle("#Xi reconstruction, MTD_L, VERTz_L, Lmass cuts");
    hXallSumSc -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    hXallSumSc -> GetYaxis() -> SetTitle("counts*#sigma");
    //    hXallSumSc -> SetMarkerStyle(34);
    //    hXallSumSc -> SetMarkerSize(1.7);
    hXallSumSc -> SetLineColor(4);
    ...
    TH1F *hrealLSumPeakClMtd = hrealLSumPeakMtd -> Clone();
    TH1F *hrealLSumPeakScClMtd = hrealLSumPeakScMtd -> Clone();
    ...
    TH1F *hrealLSumPeakScClLmass = hrealLSumPeakScLmass -> Clone();
    ...
    TH1F *hrealXSumPeakClMtd = hrealXSumPeakMtd -> Clone();
    TH1F *hrealXSumPeakScClMtd = hrealXSumPeakScMtd -> Clone();
    ...
    */
    ...
    hXallSumMtd -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    ...
    */
    ...
    nice_canv1(gPad);
    hXallSumScMtd -> SetTitle("2#pi^{-} in Hades - anything (p) in FwDet");
    hXallSumScMtd -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    hXallSumScMtd -> GetYaxis() -> SetTitle("counts*#sigma");
    hXallSumScMtd -> Draw("pE1");
    hXall90ScMtd -> Draw("p same");
    l1 -> Draw("same");
    ...
    hXallSumScMtd -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    hXallSumScMtd -> GetYaxis() -> SetTitle("counts*#sigma");
    hXallSumScMtd -> SetMarkerStyle(20);
    hXallSumScMtd -> SetMarkerSize(.5);
    hXallSumScMtd -> SetMarkerColor(4);
    hXall90ScMtd -> SetMarkerStyle(20);
    hXall90ScMtd -> SetMarkerSize(.5);
    hXallSumScMtd -> Draw("pE1");
    hXall90ScMtd -> Draw("p same");
    l1 -> Draw("same");
    ...
    hrealXSumScMtd -> SetMarkerColor(8);
    ...
    nice_canv1(gPad);
    gStyle->SetOptStat(0);
    hXallSumScMtd -> SetTitle("#Xi reconstruction, MTD_L, VERTz_L, Lmass, MTD_X cuts");
    hXallSumScMtd -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    hXallSumScMtd -> GetYaxis() -> SetTitle("counts*#sigma");
    //    hXallSumScMtd -> SetMarkerStyle(34);
    //    hXallSumScMtd -> SetMarkerSize(1.7);
    hXallSumScMtd -> SetLineColor(4);
    hXallSumScMtd -> SetLineStyle(2);
    hXallSumScMtd -> SetLineWidth(2);
    //    hrealXSumScMtd -> SetMarkerStyle(20);
    //    hrealXSumScMtd -> SetMarkerSize(1.2);
    hrealXSumScMtd -> SetLineColor(8);
    hrealXSumScMtd -> SetLineStyle(10);
    ...
    TH1F *hrealLSumPeakClVert = hrealLSumPeakVert -> Clone();
    TH1F *hrealLSumPeakScClVert = hrealLSumPeakScVert -> Clone();
    ...
    TH1F *hrealXSumPeakClVert = hrealXSumPeakVert -> Clone();
    TH1F *hrealXSumPeakScClVert = hrealXSumPeakScVert -> Clone();
    ...
    */
    ...
    hXallSumVert -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    ...
    */
    ...
    Double_t ymax;
    ymax = 2300000;
    TLine *massL_min = new TLine(MassminL, 0, MassminL, ymax);
    TLine *massL_max = new TLine(MassmaxL, 0, MassmaxL, ymax);
    massL_min -> SetLineColor(kRed);
    massL_min -> SetLineWidth(2);
    massL_max -> SetLineColor(kRed);
    massL_max -> SetLineWidth(2);
    ymax = 1800;
    TLine *massX_min = new TLine(MassminX, 0, MassminX, ymax);
    TLine *massX_max = new TLine(MassmaxX, 0, MassmaxX, ymax);
    massX_min -> SetLineColor(kRed);
    massX_min -> SetLineWidth(2);
    massX_max -> SetLineColor(kRed);
    massX_max -> SetLineWidth(2);
    ...
    nice_canv1(gPad);
    hXallSumScVert -> SetTitle("2#pi^{-} in Hades - anything (p) in FwDet");
    hXallSumScVert -> GetXaxis() -> SetTitle("M_{p#pi_{-}} [MeV]");
    hXallSumScVert -> GetYaxis() -> SetTitle("counts*#sigma");
    hXallSumScVert -> Draw("pE1");
    hXall90ScVert -> Draw("p same");
    l1 -> Draw("same");
    
    cimXsAvertsc -> cd();
    nice_canv1(gPad);
    hXallSumScVert -> SetTitle("2#pi^{-} in Hades - anything (p) in FwDet");
    hXallSumScVert -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    hXallSumScVert -> GetYaxis() -> SetTitle("counts*#sigma");
    hXallSumScVert -> SetMarkerStyle(20);
    hXallSumScVert -> SetMarkerSize(.5);
    hXallSumScVert -> SetMarkerColor(4);
    hXall90ScVert -> SetMarkerStyle(20);
    hXall90ScVert -> SetMarkerSize(.5);
    hXallSumScVert -> Draw("pE1");
    hXall90ScVert -> Draw("p same");
    l1 -> Draw("same");
    ...
    nice_canv1(gPad);
    hXallSumScVert -> SetTitle("#Xi reconstruction, MTD_L, VERTz_L, Lmass, MTD_X, VERTz_X");
    hXallSumScVert -> GetXaxis() -> SetTitle("M_{#Lambda#pi_{-}} [MeV]");
    hXallSumScVert -> GetYaxis() -> SetTitle("counts*#sigma");
    //    hXallSumScVert -> SetMarkerStyle(34);
    //    hXallSumScVert -> SetMarkerSize(1.7);
    hXallSumScVert -> SetLineColor(4);
    ...
    */
    ...
    cX_fin_sc -> cd();
    nice_canv1(gPad);
    hXmass_sc_fin -> Add(hXallSumScMtd);
